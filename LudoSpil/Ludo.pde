class Ludo{
  ...
  Ludo(){
    ...
    felter[3+(1*10)] = new Felt(feltSize*4, feltSize*4, feltSize, -1);
    felter[4+(1*10)] = new Felt(feltSize*4, feltSize*3, feltSize, -1);
    felter[5+(1*10)] = new Felt(feltSize*4, feltSize*2, feltSize, -1);
    felter[6+(1*10)] = new Felt(feltSize*4, feltSize*1, feltSize, -1);
    felter[7+(1*10)] = new Felt(feltSize*4, feltSize*0, feltSize, -1);
    felter[8+(1*10)] = new Felt(feltSize*5, feltSize*0, feltSize, -1);
    ...
    felter[3+(2*10)] = new Felt(feltSize*6, feltSize*4, feltSize, -1);
    felter[4+(2*10)] = new Felt(feltSize*7, feltSize*4, feltSize, -1);
    felter[5+(2*10)] = new Felt(feltSize*8, feltSize*4, feltSize, -1);
    felter[6+(2*10)] = new Felt(feltSize*9, feltSize*4, feltSize, -1);
    felter[7+(2*10)] = new Felt(feltSize*10, feltSize*4, feltSize, -1);
    felter[8+(2*10)] = new Felt(feltSize*10, feltSize*5, feltSize, -1);
    ...
    felter[3+(3*10)] = new Felt(feltSize*6, feltSize*6, feltSize, -1);
    felter[4+(3*10)] = new Felt(feltSize*6, feltSize*7, feltSize, -1);
    felter[5+(3*10)] = new Felt(feltSize*6, feltSize*8, feltSize, -1);
    felter[6+(3*10)] = new Felt(feltSize*6, feltSize*9, feltSize, -1);
    felter[7+(3*10)] = new Felt(feltSize*6, feltSize*10, feltSize, -1);
    felter[8+(3*10)] = new Felt(feltSize*5, feltSize*10, feltSize, -1);
